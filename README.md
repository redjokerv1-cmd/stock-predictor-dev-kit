...
이 저장소는 개발 환경 자동 구성, 디버그 도구, AI 작업 기록 시스템을 제공합니다.

> **Note**: 저장소 이름은 `stock-predictor-dev-kit`이지만, 핵심 도구들은 **모든 프로젝트에서 재사용 가능**합니다.
...
| 기능 | 설명 | 다른 프로젝트 적용 |
|------|------|-------------------|
| **원클릭 환경 구성** | setup.sh/bat 스크립트 | ✅ 저장소 URL만 수정 |
| **env-templates/** | 환경변수 템플릿 구조 | ✅ 직접 복사 |
| **디버그 도구** | import 검증, API 테스트 | ✅ 경로만 수정 |
| **Blackbox 시스템** | AI 작업 기록 (아래 상세) | ✅ 폴더 구조 복사 |
| **TROUBLESHOOTING.md** | 문제 해결 가이드 패턴 | ✅ 내용 수정 |
